...
class InvoiceForm extends React.Component {
  ...
  handleCalculateTotal() {
    ...
    items.forEach(e => {
      subTotal = subTotal + parseFloat(e.price) * parseInt(e.quantity);
    })
    ...
    this.setState(
      ...
      () => {
        this.setState(
          {
            taxAmmount: parseFloat(subTotal) * (this.state.taxRate / 100)
          },
          () => {
            this.setState(
              {
              ...
              () => {
                this.setState({
                  ...
                  parseFloat(subTotal -
                    ...
                    parseFloat(this.state.taxAmmount)).toFixed(2),
                });
              }
            );
          }
